...
注意：需通过[fei2-cli](https://github.com/chumai1984/fei2-cli)创建，该项目需要经过模板渲染之后才是正常结构
...
模板的主要配置，其中包含了fei2-cli中的问答部分`prompts`，文件可选过滤`filters`，生成文件前的最后方法（比如自动npm i）`complete`